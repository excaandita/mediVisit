...
<?= $this->section('content') ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            get_list_radiologi(); // Initial load
        ...
        function get_list_radiologi(page = 1) {
            ...
            $('.table-radiologi tbody').empty();

            $.ajax({
                type: 'GET',
                url: '<?= base_url() ?>/api/dashboard/listRadiologi',
                ...
                success: function(response) {
                    ...
                    if(response.penjamin.length !== 0) {
                        $.each(response.penjamin, function(i, v) {
                            ...
                            $('.table-radiologi tbody').append(str);
            ...
            <div class="container-xl">
                <div class="row g-2 align-items-center">
                    ...
                    <div class="col">
                        ...
                        <h2 class="page-title">Radiologi</h2>
                    </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary ms-auto" data-bs-dismiss="modal" onclick="get_list_radiologi(1)">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10 10m-7 0a7 7 0 1 0 14 0a7 7 0 1 0 -14 0" /><path d="M21 21l-6 -6" /></svg>
                        Pencarian
                    </button>
                </div>
