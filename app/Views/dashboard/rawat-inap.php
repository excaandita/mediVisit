...
<?= $this->section('content') ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            get_list_rawat_inap(); // Initial load
            ...
            $(document).on('click', '#pagination .page-link', function(e) {
                ...
                if (page) {
                    get_list_rawat_inap(page);
                }
            });

            $('#btn_search').click(function() {

                loadSelectOptions('select_bangsal', 'bangsal');
            ...
            $('#select_bangsal').on('change', function() {
                var selectedOptionBangsal = $('#select_bangsal option:selected');
                var bangsalName = selectedOptionBangsal.text();
                $('#bangsal_name_span').val(bangsalName);
            });
        ...
        function get_list_rawat_inap(page = 1) {
            let startDate = $('#start_date_search').val();
            let endDate = $('#end_date_search').val();
            let bangsalData = $('#bangsal_name_span').val() != '' && $('#select_bangsal').val() != '' ? $('#bangsal_name_span').val() : 'Semua';
            ...
            $('#bangsal_data').html(`Data Bangsal  :<b> ${bangsalData}</b>`);
            $('#penjamin_data').html(`Data Penjamin  :<b> ${penjaminData}</b>`);

            $('.table-rawat-inap tbody').empty();

            $.ajax({
                type: 'GET',
                url: '<?= base_url() ?>/api/dashboard/listRawatInap',
                ...
                success: function(response) {
                    ...
                    if(response.penjamin.length !== 0) {
                        $.each(response.penjamin, function(i, v) {
                            ...
                            $('.table-rawat-inap tbody').append(str);
            ...
            <div class="container-xl">
                <div class="row g-2 align-items-center">
                    ...
                    <div class="col">
                        ...
                        <h2 class="page-title">Rawat Inap</h2>
                    </div>
                        ...
                        <div class="row row-cards">
                            <div class="col-sm-6 col-lg-12">
                                <div class="card card-sm">
                                    <div class="card-body">
                                        <input type="hidden" id="bangsal_name_span">
                                        <input type="hidden" id="penjamin_name_span">
                                        <div class="row align-items-center">
                                            <div class="col-md-4">
                                                <div class="font-weight-medium">
                                                    <span id="bangsal_data">
                                                        <b>Data Bangsal : </b>
                                                    </span>
                                                </div>
                                            </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="search_form">
                        <div class="mb-3">
                            <label class="form-label">Bangsal</label>
                            <select class="form-select search_poli" name="id_bangsal" id="select_bangsal"></select>
                        </div>
                        <div class="mb-3">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary ms-auto" data-bs-dismiss="modal" onclick="get_list_rawat_inap(1)">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10 10m-7 0a7 7 0 1 0 14 0a7 7 0 1 0 -14 0" /><path d="M21 21l-6 -6" /></svg>
                        Pencarian
                    </button>
                </div>
